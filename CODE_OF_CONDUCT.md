...
We as members, contributors, and maintainers pledge to make participation in the **Scalable E-Commerce Microservices** project a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, religion, or sexual identity and orientation.
...
This Code of Conduct applies within all project spaces — including the issue tracker, pull requests, discussions, and any associated chat channels — and also applies when an individual is officially representing the project in public spaces (e.g., using an official project email address, posting via an official social media account, or acting as an appointed representative at an online or offline event).

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the project maintainers at:

📧 **conduct@your-org-domain.example**
